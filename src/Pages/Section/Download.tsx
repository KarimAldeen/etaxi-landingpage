        ...
        className='Download'>
            ...
            <div>
               <span>
                ...
                <p className='download_p'>{t("You can now download our app on Android and iOS.Never be stranded with E Taxi, book your cab from wherever you are, for as many of you as there are.")}
                </p>
                <h6>
